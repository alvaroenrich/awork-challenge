...
function ft() {
  ...
  let $ = class $ {
    ...
    static __load_patch(r, i, s = !1) {
      if (D.hasOwnProperty(r)) {
        ...
        if (!s && b) throw Error("Already loaded patch: " + r);
      } else if (!ie["__Zone_disable_" + r]) {
        let b = "Zone:" + r;
        n(b), (D[r] = i(ie, $, w)), a(b, b);
      }
    }
    get parent() {
      return this._parent;
    ...
    runTask(r, i, s) {
      ...
      if (r.state === X && (r.type === U || r.type === g)) return;
      let b = r.state != F;
      b && r._transitionTo(F, d), r.runCount++;
      let x = S;
      (S = r), (k = { parent: k, zone: this });
      try {
        ...
        r.state !== X &&
          r.state !== Y &&
          (r.type == U || (r.data && r.data.isPeriodic)
            ? b && r._transitionTo(d, F)
            : ((r.runCount = 0),
    ...
    scheduleTask(r) {
      ...
      try {
        ...
        throw (
          (r._transitionTo(Y, v, X), this._zoneDelegate.handleError(this, s), s)
        );
      }
      return (
    ...
    cancelTask(r) {
      ...
      if (!(r.state !== d && r.state !== F)) {
        ...
        try {
          ...
          throw (
            (r._transitionTo(Y, q), this._zoneDelegate.handleError(this, i), i)
          );
        }
        return (
          this._updateTaskCount(r, -1),
    ...
    _updateTaskCount(r, i) {
      ...
      for (let b = 0; b < s.length; b++) s[b]._updateTaskCount(r.type, i);
    }
  };
  $.__symbol__ = Q;
  let t = $,
  ...
  class _ {
    ...
    _transitionTo(r, i, s) {
      if (this._state === i || this._state === s)
        (this._state = r), r == X && (this._zoneDelegates = null);
      else
        throw new Error(
  ...
  let E = Q("setTimeout"),
    ...
    P;
  function Z(j) {
    if ((P || (ie[m] && (P = ie[m].resolve(0))), P)) {
      let r = P[C];
      r || (r = P.then), r.call(P, j);
    } else ie[E](j, 0);
  }
  function W(j) {
  ...
  let te = { name: "NO ZONE" },
    ...
    k = { parent: null, zone: new t(null, null) },
    S = null,
    K = 0;
  function z() {}
...
function $e(e, n, a) {
  let t = ve(e, n);
  if (
    (!t && a && ve(a, n) && (t = { enumerable: !0, configurable: !0 }),
    !t || !t.configurable)
  )
    return;
      ...
      (function (c) {
        typeof a[c] == "function"
          ...
          : Ae(J[e].prototype, c, {
              set: function (f) {
                typeof f == "function"
                  ? ((this[re][c] = Ge(f, e + "." + c)), ue(this[re][c], f))
                  : (this[re][c] = f);
              },
              get: function () {
                return this[re][c];
...
function gt(e, n, a) {
  ...
  t = le(
    ...
    (f) =>
      function (_, E) {
        let m = a(_, E);
        return m.cbIdx >= 0 && typeof E[m.cbIdx] == "function"
          ? Ve(m.name, E[m.cbIdx], m, c)
          : f.apply(_, E);
      },
  );
}
...
function kt(e, n, a, t) {
  let c = (t && t.add) || He,
    ...
    P = function (v, d, F) {
      ...
      typeof q == "object" &&
        q.handleEvent &&
        ((v.callback = (g) => q.handleEvent(g)), (v.originalDelegate = q));
      let Y;
      try {
        v.invoke(v, d, [F]);
      } catch (g) {
  ...
  function te(v, d) {
    ...
    let j = function (o) {
            ...
            for (let y = 0; y < R.length; y++)
              if (R[y] === o) {
                R.splice(y, 1),
                  ...
                  R.length === 0 && ((o.allRemoved = !0), (o.target[p] = null));
                break;
              }
          }
        }
      ...
      de = function (o, u) {
        let p = typeof u;
        return (
          (p === "function" && o.callback === u) ||
          (p === "object" && o.originalDelegate === u)
        );
      },
    ...
    let l = function (o, u, p, R, y = !1, O = !1) {
      return function () {
        ...
        if (De && L === "uncaughtException") return o.apply(this, arguments);
        let V = !1;
        if (typeof G != "function") {
          if (!G.handleEvent) return o.apply(this, arguments);
          V = !0;
        }
        if (q && !q(o, G, N, arguments)) return;
        ...
        if (Ee) {
          if (((qe = !0), Y)) {
            for (let se = 0; se < Ee.length; se++) if (me(Ee[se], G)) return;
          }
        } else Ee = N[We] = [];
        let we,
          ze = N.constructor.name,
          Xe = rt[ze];
        Xe && (we = Xe[L]),
          we || (we = ze + u + (U ? U(L) : L)),
          (D.options = oe),
    ...
    return (
      ...
      (g[f] = function () {
        ...
        let p = arguments[2],
          ...
          y = arguments[1];
        if (!y) return k.apply(this, arguments);
        if (q && !q(k, y, o, arguments)) return;
        let O = ee[u],
          N;
        O && (N = O[R ? ce : ae]);
        let L = N && o[N];
        if (L)
          for (let G = 0; G < L.length; G++) {
            ...
            if (me(V, y)) {
              ...
              return V.zone.cancelTask(V), B ? o : void 0;
            }
          }
  ...
  let X = [];
  for (let v = 0; v < a.length; v++) X[v] = te(a[v], t);
  return X;
}
function ct(e, n) {
  if (!n) {
    ...
    for (let _ in e) {
      ...
      if (m && (!n || m === n)) {
        let C = e[_];
        if (C) for (let T = 0; T < C.length; T++) f.push(C[T]);
      }
    }
    return f;
  }
    ...
    (C) =>
      function (T, I) {
        if (typeof I[0] == "function") {
          ...
          return (
            typeof A == "number" ? (_[A] = W) : A && (A[Re] = W),
            A &&
              A.ref &&
              A.unref &&
              typeof A.ref == "function" &&
              typeof A.unref == "function" &&
              ((W.ref = A.ref.bind(A)), (W.unref = A.unref.bind(A))),
...
function Ct(e, n) {
  if ((De && !tt) || Zone[e.symbol("patchEvents")]) return;
  ...
  if (Be) {
    ...
    let f = yt() ? [{ target: c, ignoreProperties: ["error"] }] : [];
  ...
  e.__load_patch("legacy", (n) => {
    ...
    e.__load_patch("XHR", (n, a) => {
      ...
      function C(T) {
        ...
        function v(w) {
          ...
          (S[_] = !1), (S[m] = !1);
          let K = S[f];
          W || ((W = S[Le]), (A = S[Ie])), K && A.call(S, te, K);
          let z = (S[f] = () => {
        ...
        function F(w) {
          let k = w.data;
          return (k.aborted = !0), D.apply(k.target, k.args);
        }
        let q = le(
            P,
            "open",
            () =>
              function (w, k) {
                return (w[c] = k[2] == !1), (w[E] = k[1]), q.apply(w, k);
              },
          ),
          ...
          U = le(
            ...
            () =>
              function (w, k) {
                if (a.current[g] === !0 || w[c]) return U.apply(w, k);
                {
                  let S = {
                      target: w,
                      url: w[E],
            ...
            () =>
              function (w, k) {
                ...
                if (S && typeof S.type == "string") {
                  ...
                  S.zone.cancelTask(S);
                } else if (a.current[B] === !0) return D.apply(w, k);
              },
          );
      }
    }),
    e.__load_patch("geolocation", (n) => {
      n.navigator &&
        ...
        Tt(n.navigator.geolocation, ["getCurrentPosition", "watchPosition"]);
    }),
    ...
    function $(h, l, o) {
      ...
      if (h[v] === g) {
        ...
        if (
          ...
          if (
            ((h[d] = o),
            h[F] === F && l === U && ((h[v] = h[Y]), (h[d] = h[q])),
            l === D && o instanceof Error)
          ) {
            let y =
              a.currentTask && a.currentTask.data && a.currentTask.data[P];
            y &&
              f(o, z, {
                configurable: !0,
                enumerable: !1,
          ...
          for (let y = 0; y < R.length; ) i(h, R[y++], R[y++], R[y++], R[y++]);
          if (R.length == 0 && l == D) {
            h[v] = w;
            let y = o;
            try {
    ...
    class M {
      ...
      static any(l) {
        ...
        let o = [],
          u = 0;
        try {
          for (let y of l) u++, o.push(M.resolve(y));
        } catch {
          return Promise.reject(new x([], "All promises were rejected"));
        }
        if (u === 0)
            ...
            o[N].then(
              ...
              (L) => {
                R.push(L),
                  u--,
                  u === 0 &&
                    ((p = !0), O(new x(R, "All promises were rejected")));
              },
            );
        });
      }
      static race(l) {
        ...
        for (let O of l) A(O) || (O = this.resolve(O)), O.then(R, y);
        return p;
      }
      static all(l) {
      ...
      static allWithCallback(l, o) {
        ...
        for (let L of l) {
          ...
          try {
            L.then(
              (V) => {
                (N[G] = o ? o.thenCallback(V) : V), y--, y === 0 && u(N);
              },
              (V) => {
                o ? ((N[G] = o.errorCallback(V)), y--, y === 0 && u(N)) : p(V);
              },
            );
          } catch (V) {
            p(V);
      ...
      then(l, o) {
        ...
        let p = new u(b),
          R = a.current;
        return this[v] == g ? this[d].push(R, p, l, o) : i(this, R, p, l, o), p;
      }
      catch(l) {
        ...
        u[F] = F;
        let p = a.current;
        return this[v] == g ? this[d].push(p, u, l, l) : i(this, p, u, l, l), u;
      }
    }
    (M.resolve = M.resolve),
      (M.reject = M.reject),
            ...
            if (P.hasOwnProperty(T)) {
              ...
              Z && Z.value
                ? ((Z.value = e.wrapWithCurrentZone(Z.value, I)),
                  e._redefineProperty(m.prototype, T, Z))
                : P[T] && (P[T] = e.wrapWithCurrentZone(P[T], I));
            } else P[T] && (P[T] = e.wrapWithCurrentZone(P[T], I));
          } catch {}
        }),
      _.call(n, E, m, C)
    );
